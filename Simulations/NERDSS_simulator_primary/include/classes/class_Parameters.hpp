...
struct Parameters {
    ...
    std::vector<double> k_AA = {};
    std::vector<double> k_AB = {};
    std::vector<double> k_BB = {};
    std::vector<double> k_AC = {};
    std::vector<double> k_BC = {};
    std::vector<double> k_CC = {};
    std::vector<double> kub_AA = {}; 
    std::vector<double> kub_AB = {}; 
    std::vector<double> kub_BB = {}; 
    std::vector<double> kub_AC = {}; 
    std::vector<double> kub_BC = {}; 
    std::vector<double> kub_CC = {}; 

    //rxn_series
    std::vector<double> rxn_AA ; // vector with 78 ints.
    std::vector<double> rxn_AB ; // vector with 144 ints.
    std::vector<double> rxn_BB ; // vector with 144 ints.
    std::vector<double> rxn_AC ;
    std::vector<double> rxn_BC ; // vector with 78 ints.
    std::vector<double> rxn_CC ; // vector with 144 ints.
